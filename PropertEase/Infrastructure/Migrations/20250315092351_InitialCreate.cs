    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PropertyPurposeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyPurposes", x => x.PropertyPurposeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyPurposeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_Categories_CategoryId1",
                        column: x => x.CategoryId1,
                        principalTable: "Categories",
                        principalColumn: "CategoryId");
                    table.ForeignKey(
                        name: "FK_Properties_PropertyPurposes_PropertyPurposeId",
                        column: x => x.PropertyPurposeId,
                        principalTable: "PropertyPurposes",
                        principalColumn: "PropertyPurposeId");
                    table.ForeignKey(
                        name: "FK_Properties_PropertyPurposes_PurposeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentLicenseNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgencyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Region = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProfilePictureImageId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "PropertyPurposes",
                columns: new[] { "PropertyPurposeId", "Name" },
                values: new object[,]
                {
                    { 1, "Sale" },
                    { 2, "Rent" }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_CategoryId1",
                table: "Properties",
                column: "CategoryId1");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_PropertyPurposeId",
                table: "Properties",
                column: "PropertyPurposeId");
